...
DOCKER_CONTAINER_STARTUP_CMD="sudo docker-compose up"
...
ssh -i "${EC2_PEM_KEY_PATH}" "ec2-user@${EC2_PUBLIC_DNS}" ${SCRIPTS_DESTINATION_FOLDER}/"${DOCKER_CONTAINER_STARTUP_CMD}"
